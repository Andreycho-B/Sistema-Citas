...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // La función login ahora devuelve los datos del usuario, incluyendo los roles
      const userData = await login(email, password);

      // Lógica de redirección basada en los roles devueltos
      if (userData.roles.includes('ADMIN')) {
        navigate('/admin/dashboard');
      } else if (userData.roles.includes('PROFESSIONAL')) {
        navigate('/professional/dashboard');
      } else {
        navigate('/dashboard'); // Dashboard por defecto para USER
      }
